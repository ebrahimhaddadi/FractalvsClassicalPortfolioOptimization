...
#     end = '2020-01-01'
#
#     # ایجاد پوشه outputs/figures اگر وجود نداشت
...
#     print(returns.head())
#
#     # بخش جدید: محاسبه وزن‌های پرتفو در طول زمان (rolling monthly)
#     print_section("محاسبه وزن‌های پرتفو به‌صورت ماهانه")
#     monthly_weights = []
#     for date in returns.index[::21]:  # تقریباً هر ماه یک بار
#         subset = returns.loc[:date].tail(60)  # آخرین 60 روز معاملاتی
...
#         weights_df = pd.DataFrame()  # ایجاد دیتافریم خالی برای جلوگیری از کرش
#
#     # بخش 3: محاسبه Hurst
...
#     plt.close()
#
#     # بخش 7: ترسیم نمودار stacked weights
